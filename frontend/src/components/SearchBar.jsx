  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto" ref={dropdownRef}>
      ...
      {showDropdown && hasSuggestions && (
        <div className="absolute left-0 right-0 mt-2 bg-white border border-slate-200/80 rounded-3xl shadow-xl z-50 max-h-96 overflow-y-auto p-4 space-y-4 text-left">
          
          {/* Categories / Genres */}
          {suggestions.categories.length > 0 && (
            <div>
              <h4 className="text-[10px] font-bold text-amber-700 uppercase tracking-widest mb-1.5 px-3">
                Categories
              </h4>
              <div className="space-y-0.5">
                {suggestions.categories.slice(0, 3).map((cat) => (
                  <button
                    ...
                    className="w-full text-left px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-amber-800 rounded-xl transition duration-150 flex items-center gap-2 cursor-pointer"
                  >
              ...
              <div className="space-y-0.5">
                {suggestions.books.map((book) => (
                  <button
                    ...
                    className="w-full text-left px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-amber-800 rounded-xl transition duration-150 flex items-center justify-between cursor-pointer"
                  >
