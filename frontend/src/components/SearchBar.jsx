  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto" ref={dropdownRef}>
      ...
      {showDropdown && hasSuggestions && (
        <div className="absolute left-0 right-0 mt-2 bg-white border border-slate-200/80 rounded-3xl shadow-xl z-50 max-h-96 overflow-y-auto p-4 space-y-4 text-left dark:bg-slate-100 dark:border-slate-300">
              ...
              <div className="space-y-0.5">
                {suggestions.categories.slice(0, 3).map((cat) => (
                  <button
                    ...
                    className="w-full text-left px-3 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-amber-800 dark:hover:text-amber-400 rounded-xl transition duration-150 flex items-center gap-2 cursor-pointer"
                  >
              ...
              <div className="space-y-0.5">
                {suggestions.books.map((book) => (
                  <button
                    ...
                    className="w-full text-left px-3 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-amber-800 dark:hover:text-amber-400 rounded-xl transition duration-150 flex items-center justify-between cursor-pointer"
                  >
