...
const BookCard = ({ book }) => {
  ...
  return (
    <div 
      className="group border border-slate-200/50 hover:border-amber-700/20 bg-white rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 ease-out overflow-hidden flex flex-col h-full"
    >
      ...
      <div className="p-4 flex flex-col flex-1 text-left">
        ...
        <h2 className="font-serif font-bold text-base sm:text-lg text-slate-900 line-clamp-2 mb-2 leading-snug">
          {title}
        </h2>
