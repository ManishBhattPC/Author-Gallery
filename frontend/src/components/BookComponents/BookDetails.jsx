                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  {book?.pdfFile && (
                    <a
                      ...
                      className="flex-1 flex items-center justify-center gap-2 border border-[#4A403A] text-[#FAF6F0] bg-[#1A1614] hover:bg-[#2A2421] px-5 py-3.5 rounded-xl font-bold transition duration-200 cursor-pointer shadow-md active:scale-[0.98]"
                    >
                      <FaDownload />
